     ...
     <li class="movie-list" data-id = 'info.id'>
        <a class="movie-list_item after-border">
            <div class="movie-item_img">
                <img :src="changeImg(info.img)" onerror="this.style.visibility='hidden'">
            </div>
            <div class="movie-item_info">
                ...
                <div class="movie-detail_column">
                    ...
                    <div class="line-ellipsis">主演: {{info.star}}</div>
                    <div class="line-ellipsis">{{info.showInfo}}</div>
                </div>         
            </div>
...
<script>
    export default {
        ...
        methods:{
            changeImg(img){
                let changeimg = img.replace('w.h','128.180');
                return changeimg
            }
        }
    };
